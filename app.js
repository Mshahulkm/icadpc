...
(function(){
  ...
  if(!app) return;
  let winners = null;
  const STAGES = ['loading','welcome','game','history','trophy','fourth','third','runnerup','champion','hall','stats','timeline','gallery','credits'];
  let stage = 'loading';

  // Winner cards use images from /assets/ folder
  const WIN = {
    champion:'/assets/winner-champion.jpg',
    runnerup:'/assets/winner-runnerup.jpg',
    third:'/assets/winner-third.jpg',
    topScorer:'/assets/winner-topscorer.jpg',
    stadium:'/assets/stadium.jpg',
    trophy:'/assets/trophy.jpg'
  };
  // Moments gallery uses images from /moment-images/ folder
  const MOMENTS = [
    '/moment-images/stadium.jpg',
    '/moment-images/trophy.jpg',
    '/moment-images/champion.jpg',
    '/moment-images/runnerup.jpg',
    '/moment-images/third.jpg',
    '/moment-images/topScorer.jpg'
  ];
